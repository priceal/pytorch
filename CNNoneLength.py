...
def dataReader(filePath, lengths=(0,800), crop=800):
    ...
    Args:
        ...
        minLen (TYPE, optional): DESCRIPTION. Defaults to 0.
        crop (TYPE, optional): DESCRIPTION. Defaults to 800.
...
class cnnModel(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.layer3 = torch.nn.Conv1d(in_channels=6,
                                      out_channels=3,
                                      kernel_size=11,
                                      stride=1,
                                      padding='same')
